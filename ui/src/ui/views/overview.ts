    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          ...
          <span class="mono">gateway.controlUi.allowInsecureAuth: true</span> ${t("overview.insecureContextSuffix")}
        </div>
        <div style="margin-top: 6px">
          <a
            class="session-link"
            ...
            target="_blank"
            rel="noreferrer"
            title="${t("overview.docsTailscaleServe")}"
